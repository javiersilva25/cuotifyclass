...
export function DeudasAlumnoPage() {
  ...
  const { validateDeudaForm, validatePagoForm } = useDeudaAlumnoValidation();
  ...
  const statsData = [
    ...
    },
    {
      ...
      icon: 'DollarSign',
      color: 'green',
      description: 'Valor total de deudas',
    },
    {
    ...
    <>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Estado actual de la gestión de deudas de alumnos
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center p-4 bg-orange-50 rounded-lg">
              ...
              <p className="text-2xl font-bold text-orange-700">
                {stats.alumnosConDeudas}
              </p>
              <p className="text-xs text-orange-600 mt-1">
                {stats.activas} deudas activas
              </p>
            </div>
      ...
      {Object.keys(stats.porEstado).length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Cantidad de deudas por estado actual
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      {/* Distribución por tipo y planes de pago */}
            ...
            <div className="space-y-4">
              ...
              {stats.conPlanPago > 0 && (
                <div className="pt-2">
                  ...
                  <Progress 
                    value={(stats.conPlanPago / stats.total) * 100} 
                    className="h-2"
                  />
                </div>
              )}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Actividad de deudas en el mes en curso
          </CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <Card className="border-red-200 bg-red-50">
          <CardHeader>
            ...
            <CardDescription className="text-red-600">
              Deudas que requieren atención inmediata
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  max={deudaPago.monto_pendiente}
                  defaultValue={deudaPago.monto_pendiente}
                />
              </div>
              <div>
              ...
              <div className="flex space-x-2">
                ...
                <Button 
                  onClick={() => handleConfirmarPago({ 
                    monto_pago: deudaPago.monto_pendiente,
      ...
      {/* Formulario de refinanciación (simplificado para demo) */}
          ...
          <Card className="max-w-md w-full mx-4">
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  placeholder="Describe el nuevo plan de pago..."
                  rows={3}
                />
              </div>
              <div className="flex space-x-2">
                <Button 
                  variant="outline" 
                  onClick={() => setShowRefinanciarForm(false)}
                  className="flex-1"
                >
                  Cancelar
                </Button>
                <Button 
                  onClick={() => handleConfirmarRefinanciacion({ 
                    nueva_fecha_vencimiento: new Date(Date.now() + 30*24*60*60*1000).toISOString().split('T')[0],
