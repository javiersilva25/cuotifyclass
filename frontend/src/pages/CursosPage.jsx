...
export function CursosPage() {
  const { canManageCursos } = usePermissions();
  ...
  const statsData = [
    ...
    },
    {
      ...
      value: stats.alumnosMatriculados,
      icon: 'Users',
      color: 'emerald',
  ...
  return (
    ...
    <Navbar />
      ...
      >
      {/* Todo el contenido actual que ya tienes */}
      {/* Header */}
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Administra los cursos y programas académicos del centro educativo
          </p>
        </div>
        
        <Button onClick={handleCreateCurso} size="lg">
      ...
      {Object.keys(stats.porNivel).length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Número de cursos activos por nivel académico
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      {stats.cursosMayorDemanda.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Cursos con mayor porcentaje de ocupación
            </CardDescription>
          </CardHeader>
          <CardContent>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          {curso.nivel} - {curso.profesor_principal}
                        </p>
                      </div>
                    </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Estadísticas generales de capacidad y ocupación
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center p-4 bg-purple-50 rounded-lg">
              <p className="text-2xl font-bold text-purple-600">
                {stats.ocupacionPromedio.toFixed(1)}%
              </p>
